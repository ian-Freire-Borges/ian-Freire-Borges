...
<div style="margin-top: 20px; display: flex; flex-direction: column; gap: 40px; padding: 10px 0; align-items: flex-start; pointer-events: none">
...
<div style="display: flex; margin-top: 10px; gap: 20px; justify-content: center; align-items: center;pointer-events: none">
